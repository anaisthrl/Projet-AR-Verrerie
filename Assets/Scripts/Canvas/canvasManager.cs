...
public class canvasManager : MonoBehaviour
{
    ...
    public void goLeft()
    {
        ...
        Debug.Log("Left ! Collection = " + CollectionManager.chosenCollectionId);
    ...
    public void goRight()
    {
        ...
        else CollectionManager.chosenCollectionId = 0;
        Debug.Log("Right! Collection = " + CollectionManager.chosenCollectionId);
        collectionManager.SetCollection();
    }
}
